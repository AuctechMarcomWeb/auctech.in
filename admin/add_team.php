...
if (isset($_POST['submit']))
{
    ...
    $image_name = "team_" . $unique_id . "." . $extension;
    ...
    $sql = "INSERT INTO add_team (name, review, designation, image_path) 
    ...
    <div class="page-content fade-in-up">
        <div class="row">
            <div class="col-md-6 col-lg-12">
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">Add New Team Member</div>
                    </div>
                    <div class="ibox-body">
                        <form method="POST" action="" enctype="multipart/form-data">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label>Team Member Profile  (Size: 180*180)</label>
