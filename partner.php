...
<body class="counter-scroll-8">
    ...
    <div id="wrapper">
        ...
        <div class="main-content padding-0">
           ...
           <div class="container py-5 mt-8r mb-8r">
                <div class="row justify-content-center g-4 text-center">
                    <div class="col-md-4 col-sm-6 col-8 ">
                    <img class="img-width" src="images/partner/1.jpg" alt="Partner 1" class="logo-img img-fluid">
                    </div>
                    <div class="col-md-4 col-sm-6 col-8 ">
                    <img class="img-width" src="images/partner/2.jpg" alt="Partner 2" class="logo-img img-fluid">
                    </div>
                    <div class="col-md-4 col-sm-6 col-8 ">
                    <img class="img-width" src="images/partner/3.jpg" alt="Partner 3" class="logo-img img-fluid">
                    </div>
                    
                </div>
                <div class="row justify-content-center g-4 text-center mt-50">
                    <div class="col-md-4 col-sm-6 col-8 ">
                    <img class="img-width" src="images/partner/4.jpg" alt="Partner 4" class="logo-img img-fluid">
                    </div>
                    <div class="col-md-4 col-sm-6 col-8 ">
                    <img class="img-width" src="images/partner/5.jpg" alt="Partner 5" class="logo-img img-fluid">
                    </div>
                    <div class="col-md-4 col-sm-6 col-8 ">
                    <img class="img-width" src="images/partner/6.jpg" alt="Partner 6" class="logo-img img-fluid">
                    </div>
                </div>
            </div>
